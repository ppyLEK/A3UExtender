...
["name", ""] call _fnc_saveToTemplate; //Name of rival faction
["nameLeader", ""] call _fnc_saveToTemplate; //Name of rival faction leader

//////////////////////////////////////
//       	Identities    			//
//////////////////////////////////////

// Faces and voices givent to Rival AI
...
["vehiclesRivalsLightArmed", []] call _fnc_saveToTemplate;                          //Must contain light armed vehicles such as technicals
["vehiclesRivalsCars", []] call _fnc_saveToTemplate;                                //Must contain light unarmed and unarmored vehicles
["vehiclesRivalsTrucks", ["I_C_Van_01_transport_F"]] call _fnc_saveToTemplate;      //Must contain cargo trucks
["vehiclesRivalsAPCs", []] call _fnc_saveToTemplate;                                //May contain APCs
["vehiclesRivalsTanks", []] call _fnc_saveToTemplate;                               //May contain tanks
["vehiclesRivalsHelis", []] call _fnc_saveToTemplate;                               //May contain helis
["vehiclesRivalsUavs", []] call _fnc_saveToTemplate;                                //May contain UAVs

["staticLowWeapons", []] call _fnc_saveToTemplate;                                  //Must contain static MGs
["staticAT", []] call _fnc_saveToTemplate;                                          //Must contain static AT weapons
["staticMortars", []] call _fnc_saveToTemplate;                                     //Must contain static mortar

["mortarMagazineHE", "8Rnd_82mm_Mo_shells"] call _fnc_saveToTemplate;               //Must contain HE rounds suitable for specified mortar

["handGrenadeAmmo", []] call _fnc_saveToTemplate;                                   //Must contain hand grenade ammo
["mortarAmmo", ["Sh_82mm_AMOS"]] call _fnc_saveToTemplate;

["minefieldAT", ["ATMine"]] call _fnc_saveToTemplate;                               //Must contain AT mines
["minefieldAPERS", ["APERSMine", "APERSBoundingMine"]] call _fnc_saveToTemplate;    //Must contain APERS mines

//////////////////////////
//       Loadouts       //
//////////////////////////
private _loadoutData = call _fnc_createLoadoutData;
//Arrays of different weapon types, each of them should at least have 1 entry
private _rifles = [];
...
//That way you can add additional items if some condition is met
if (_hasContact) then {
	_carbines pushBack [];
};
...
_loadoutData set ["ATMines", []];                               //AT mines to spawn in AI inventories
_loadoutData set ["APMines", []];                               //APERS mines to spawn in AI inventories
_loadoutData set ["lightExplosives", []];                       //Light IEDs
_loadoutData set ["heavyExplosives", []];                       //Heavy IEDs

_loadoutData set ["antiInfantryGrenades", []];                  //Hand hrenades
_loadoutData set ["smokeGrenades", []];                         //Smoke grenades
_loadoutData set ["signalsmokeGrenades", []];                   //Signal smoke grenades (typically colored versions)

_loadoutData set ["facewear", []];                              //Facewears
_loadoutData set ["fullmask", []];                              //Fullmasks

_loadoutData set ["headgear", []];                              //Headgear (hemlet slot but no armor)
...
_loadoutData set ["uniforms", []];                              //Uniforms

_loadoutData set ["offuniforms", []];                           //Officer uniforms
_loadoutData set ["vests", []];                                 //Vests
_loadoutData set ["backpacks", []];                             //Backpacks
_loadoutData set ["helmets", []];                               //Helmets
_loadoutData set ["crewHelmets", []];                           //Crew helmets
...
private _slItems = [];                                          //Extra items to spawn on squad leaders
private _eeItems = [];                                          //Extra items to spawn on engineers
private _mmItems = [];                                          //Extra items to spawn on snipers

//Items to add if ACE is loaded
if (A3A_hasACE) then {
...
//Extra items to spawn on unit of certain class
...
_crewLoadoutData set ["vests", []];                             //Crew vests
_crewLoadoutData set ["helmets", []];                           //Crew helmets

private _pilotLoadoutData = _loadoutData call _fnc_copyLoadoutData;
_pilotLoadoutData set ["vests", []];                            //Pilot vests
_pilotLoadoutData set ["helmets", []];                          //Pilot helmets
